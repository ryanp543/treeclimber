...
def main(args=None):
    ...
    # 150 mm command
    # my_controller.send_command(4, [0, 4.7, 0, 0])

    # 90 mm command
    # my_controller.send_command(4, [0, 4.9, 0, 0])

    # 168 mm command
    my_controller.send_command(4, [0, 4.3, 0, 0])

    # 220 mm command
    # my_controller.send_command(4, [0, 4.6, 0, 0])
    ...
    # 220 mm command
    # my_controller.send_command(5, [0, -3.4, 0, 0])   
