...
HOST = "localhost"
PORT = 4223
UID = "Gnh" # Change XYZ to the UID of your CAN Bricklet 2.0
...
if __name__ == "__main__":
    ...
    can.set_transceiver_configuration(250000, 625, can.TRANSCEIVER_MODE_LOOPBACK)
    ...
    can.write_frame(can.FRAME_TYPE_EXTENDED_DATA, 1, [42, 23, 17])
    print("sent frame")
